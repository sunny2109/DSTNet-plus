...
def main():
    ...
    # HR images
    opt['input_folder'] = '/data0/sun_proj/BasicSR/datasets/DIV2K/DIV2K_valid_HR'
    opt['save_folder'] = '/data0/sun_proj/BasicSR/datasets/DF2K_new/DF2K_train_HR_sub1'
    opt['crop_size'] = 480
    opt['step'] = 240
    opt['thresh_size'] = 0
    ...
    # LRx4 images
    opt['input_folder'] = '/data0/sun_proj/BasicSR/datasets/DIV2K/DIV2K_valid_LR_bicubic/X4'
    opt['save_folder'] = '/data0/sun_proj/BasicSR/datasets/DF2K_new/X4_sub'
    opt['crop_size'] = 120
    opt['step'] = 60
    opt['thresh_size'] = 0
    extract_subimages(opt)
